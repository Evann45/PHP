...
<head>
    ...
    // Fonction pour afficher ou cacher le bouton en fonction des valeurs des champs de recherche
    function toggleClearFilterButton() {
        var searchByNameValue = document.getElementById('searchByName').value;
        var searchByScoreValue = document.getElementById('searchByScore').value;

        // Affiche le bouton si au moins l'un des champs de recherche est rempli
        document.getElementById('clearFilterButton').style.display =
            searchByNameValue !== '' || searchByScoreValue !== '' ? 'inline-block' : 'none';
    }
    </script>
